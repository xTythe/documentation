...
Credibility is a standard designed to achieve comprehensive inclusivity, greater accuracy, and higher granularity for increased predictive power and a wider range of use cases using aggregated intelligence across five primary metrics:
...
* **For Creditworthiness (Traditional off-chain models):** \
...
* **For Creditworthiness (Current on-chain models):** \
