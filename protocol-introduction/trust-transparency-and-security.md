...
Synclear insures its own failures. Where a loss is caused by the protocol falling short at its job, a contract exploit, a manager malfunction, or an underwriting error, insurance stands behind it. Where a loss is the market outcome of a strategy an investor knowingly chose, it is not insured. That line, we cover our failures, you bear the risk you opted into, runs through every product.
...
* **Underwriting Insurance, on the Cashflow Credit Fund.** The credit fund carries a first-loss buffer, funded from retained revenue and seed capital, that absorbs initial losses before they reach investors. Beyond it, Underwriting Insurance reimburses losses that trace to an error in Synclear's own underwriting. Neither covers ordinary credit losses: a soundly-underwritten borrower who still defaults is the credit risk the investor knowingly took.
